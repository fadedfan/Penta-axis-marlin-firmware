...
#define AUTOTEMP
  ...
  #define AUTOTEMP_FACTOR       0.1f //by prusa
...
#define SENSORLESS_BACKOFF_MM  { 2, 2, 1, 1, 1 }  // (linear=mm, rotational=°) Backoff from endstops before sensorless homing

#define HOMING_BUMP_MM      { 1, 1, 2, 2, 2 }       // (linear=mm, rotational=°) Backoff from endstops after first bump
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 50*60, 50*60, 4*60,50*60, 50*60, 2*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
 ...
 */
  ...
  #define I_HYBRID_THRESHOLD       15  // [linear=mm/s, rotational=°/s]
  #define J_HYBRID_THRESHOLD       15  // [linear=mm/s, rotational=°/s]
  ...
  #define SENSORLESS_HOMING // StallGuard capable drivers only
    ...
    #define I_STALL_SENSITIVITY  125
    #define J_STALL_SENSITIVITY  125
